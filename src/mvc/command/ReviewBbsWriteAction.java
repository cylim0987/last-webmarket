...
public class ReviewBbsWriteAction implements CommandReviewBbs{
	@Override
	public String action(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ReviewBbsDAO dao = ReviewBbsDAO.getInstance();
			...
			//insertReviewBbs()메소드에 넘길 객체 생성 후, 속성에 값 설정
			ReviewBbsDTO reviewBbs = new ReviewBbsDTO();
			reviewBbs.setId(id);
			reviewBbs.setName(name);
			reviewBbs.setSubject(subject);
			reviewBbs.setContent(content);
