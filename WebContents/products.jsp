...
<div class="jumbotron" style="background:white;">
  <div class="container">
     <h1 class="display-3">${param.category }</h1>
     
<%--      <div id="recentPanel" 
     class="card bg-light mb-3" 
      style="position:fixed; width:12rem; top:55px; right:10px; text-align:center;" >
   ...
   <div class="row" align="center">
    <%@ include file="dbconn.jsp" %>
     <%  /* DB로 부터 상품 정보 리스트 얻기 */
        ...
        ResultSet rs = null;
        String sql = "select * from product where p_category='"+ category+"'order by p_id";
