        ...
        <tr>
         <td width="100%" align="left">&nbsp;&nbsp;
          <select name="items" class="txt">
                <option value="subject"  <c:if test="${items=='subject'}">selected</c:if>>제목</option>
                <option value="content" <c:if test="${items=='content'}">selected</c:if>>본문</option>
                <option value="writer" <c:if test="${items=='writer'}">selected</c:if> >글쓴이</option>
                <option value="category" <c:if test="${items=='category'}">selected</c:if> >카테고리</option>
          </select>
