...
<%
    String sql="select max(ifnull(seq,'')) seq ,max(ifnull(name,'')) Name, "
              +" max(ifnull(zipcode,'')) zipcode, "
...
<div class="container">
   <form name="frm" action="./processShippingInfo.jsp" class="form-horizontal" method="post">
         ...
         <div class="form-group row">
             <label class="col-sm-2">받으실분</label>
             <div class="col-sm-3">
                 <input name="name" type="text" class="form-control" value="<%=rs.getString("Name")!=null?rs.getString("Name"):""%>">
